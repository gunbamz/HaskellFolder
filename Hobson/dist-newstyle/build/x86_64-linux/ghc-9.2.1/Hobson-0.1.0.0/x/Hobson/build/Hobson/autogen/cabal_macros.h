...
/* package Hobson-0.1.0.0 */
#ifndef VERSION_Hobson
#define VERSION_Hobson "0.1.0.0"
#endif /* VERSION_Hobson */
#ifndef MIN_VERSION_Hobson
#define MIN_VERSION_Hobson(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Hobson */
...
#define CURRENT_COMPONENT_ID "Hobson-0.1.0.0-inplace-Hobson"
